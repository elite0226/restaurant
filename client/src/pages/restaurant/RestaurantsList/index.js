    ...
    <>
      {profile.role === ROLES.OWNER && (
        <Box display="flex" justifyContent="flex-end" mb={2}>
          <Button variant="contained" color="primary" disableElevation onClick={handleCreateRestaurant}>
                  ...
                  <TableRow key={restaurant.id}>
                    ...
                    {profile.role === ROLES.ADMIN && (
                      <TableCell className={classes.noPadding}>
                        ...
                        <IconButton>
                          <DeleteIcon color="error" onClick={handleDeleteRestaurant(restaurant.id)} />
                        </IconButton>
                      </TableCell>
                    )}
                    <TableCell className={classes.noPadding}>
